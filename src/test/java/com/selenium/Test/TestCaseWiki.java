...
public class TestCaseWiki {
	...
	public Object[][] createDataIdioma() {
		return new Object[][] { { "af", "Afrikaans", "Selenium", "Seleen" },
				{ "es", "Español", "Selenium", "Slenium" }, { "pt", "Português", "Selenium", "Selênio" },
				{ "de", "Deutsch", "Selenium", "Selenium" }, { "en", "English", "Selenium", "Selenium" }, };
	}

	@Test(dataProvider = "dataIdiomas", description = "Validar que funcionen búsquedas con diferentes idiomas - TDD")
	public void BusquedaConDiferentesIdiomas(String vIdioma, String Descrip, String vBusqueda, String resultado)
			throws Exception {
